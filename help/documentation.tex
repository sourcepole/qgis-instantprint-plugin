...
\fancyhead[R]{\includegraphics[width=.25\textwidth]{logo_text.pdf}}
...
%Misc
\usepackage{amsfonts,amssymb,amsmath,amsopn,amsthm,tabularx}
\usepackage{enumitem}

%Custom commands
\newcommand{\clearemptydoublepage}{\newpage{\pagestyle{empty}\cleardoublepage}}
%\renewcommand\thechapter{\Roman{chapter}} %For documentclass report only
